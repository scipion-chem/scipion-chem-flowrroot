...
`FLOWR.root <https://github.com/jule-c/flowr_root/>`_
These tools will generate new ligands.
...
.. code-block::
    ...
    scipion3 installp -p scipion-chem-flowrroot
...
- **Developer's version**
    ...
    .. code-block::
        ...
        git clone https://github.com/scipion-chem/scipion-chem-flowrroot.git

    2. **Switch to the desired branch** (master or devel):

    Scipion-chem-flowrroot is constantly under development and including new features.
    If you want a relatively older an more stable version, use master branch (default).
    If you want the latest changes and developments, user devel branch.

    .. code-block::

                cd scipion-chem-flowrroot
                git checkout devel
    ...
    .. code-block::
        ...
        scipion3 installp -p path_to_scipion-chem-flowrroot --devel
